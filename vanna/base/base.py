...
class SqlCxCopilotBase(ABC):
    ...
    def generate_sql(self, question: str, dialect: str, **kwargs) -> str:
        question_sql_list = self.get_similar_question_sql(question, **kwargs)
        ddl_list = self.get_related_ddl(question, **kwargs)
        doc_list = self.get_related_documentation(question, **kwargs)
        label_list = self.get_related_label(question, **kwargs)
    ...
    def ask(
        ...
        sql = self.generate_sql(question=question, dialect=dialect)
...
class SplitStorage(SqlCxCopilotBase):
